...
for l in range(len(wx_stations_name)):  
    ...
    if wx_stations_name[l] == 'mountmaya':
        sql_file_idx_latest = int(np.flatnonzero(sql_file['DateTime'] == '2024-07-01 00:00:00')[0]) if np.flatnonzero(sql_file['DateTime'] == '2024-07-01 00:00:00').size > 0 else 0  # arbitrary date
